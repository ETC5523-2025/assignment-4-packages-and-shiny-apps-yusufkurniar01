...
The package provides three simulation tables for HAIs in Germany (2011 – 2012):
...
For details on the data source and variable definitions, see the [Data Description](articles/data-description.html) article, and the examples of common analysis steps are provided in the [Examples](articles/examples.html) article.
