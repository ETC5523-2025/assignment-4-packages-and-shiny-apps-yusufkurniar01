...
For details on the data source and variable definitions, see the [Data Description](https://etc5523-2025.github.io/assignment-4-packages-and-shiny-apps-yusufkurniar01/articles/data-description.html), and the examples of common analysis steps are provided in the [Examples](https://etc5523-2025.github.io/assignment-4-packages-and-shiny-apps-yusufkurniar01/articles/examples.html).
...
For more information regarding the analysis, please check the live Shiny dashboard [App](https://yusufkurniar01.shinyapps.io/yusufHAIGermany/) and [Examples](https://etc5523-2025.github.io/assignment-4-packages-and-shiny-apps-yusufkurniar01/articles/examples.html).
